...
def inject_custom_css():
    ...
    *{box-sizing:border-box;margin:0;padding:0}
    ...
    .cc .cv{font-size:28px;font-weight:900;line-height:1.1;}
    .cc .cl{font-size:11px;color:#64748b;font-weight:700;text-transform:uppercase;letter-spacing:.5px;margin-top:4px;}
