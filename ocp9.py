...
def main():
    ...
    def calc_kpis(df_i, av_i, now_ts, posts):
        ...
        # Dans la section PRÉPARATION (autour de la ligne 424)
        ...
        pr["OT préparation >3 mois"] = 100 - ckpi(pr[">3 mois"], pr["Total"], 0)
        pr["OT préparation 1mois< <3mois"] = 100 - ckpi(pr["1 mois < <3 mois"], pr["Total"], 0)
        ...
        pl["OT planification >3 mois"] = 100 - ckpi(pl[">3 mois"], pl["Total"], 0)
        pl["OT planification 1mois< <3mois"] = 100 - ckpi(pl["1 mois < <3 mois"], pl["Total"], 0)
        ...
        ex["OT exécution >3 mois"] = 100 - ckpi(ex[">3 mois"], ex["Total"], 0)
        ex["OT exécution 1mois< <3mois"] = 100 - ckpi(ex["1 mois < <3 mois"], ex["Total"], 0)
